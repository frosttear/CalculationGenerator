...
window.enTranslations = {
  ...
  "verticalEquationsTitle": "Grade 1 Vertical Equations",
  "verticalEquationsDescription": "Grade 1 vertical addition and subtraction problems.",
  ...
  "additionCount": "Addition equations per day",
  "subtractionCount": "Subtraction equations per day",
  ...
  "enableLeastDigitConstraint": "Enable No Carry from Ones Place",
  "leastDigitConstraintDescription": "For two-digit × one-digit only: no carry from ones place, easier mental math (e.g., 21×7✓, 14×3✗, 6×4✓)",
